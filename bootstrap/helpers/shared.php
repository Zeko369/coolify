...
function generate_fluentd_configuration(): array
{
    return [
        ...
        'options' => [
            ...
            // labels and env vars are used in the LogDrain configurations
            'labels' => 'coolify.resourceName,coolify.projectName,coolify.environmentName,coolify.serviceName,coolify.type',
            'env' => 'SOURCE_COMMIT,COOLIFY_BRANCH',
        ],
    ];
}
